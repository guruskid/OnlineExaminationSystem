...
include("head.php");
    ...
    echo "<BR><center><u><h2>Add Question </h3></u></center>";
    if($_POST[submit]=='Save' || strlen($_POST['testid'])>0 )
    {
    extract($_POST);
    mysql_query("insert into questions(test_id,que_desc,ans1,ans2,ans3,ans4,true_ans) values ('$testid','$addque','$ans1','$ans2','$ans3','$ans4','$anstrue')",$cn) or die(mysql_error());
    ...
    <form name="form1" method="post" onSubmit="return check();">
      ...
      <!--TABLE BEGINS HERE-->
      <table class="table table-hover"width="80%"  border="0" align="center">
        <tr>
    ...
    <?php
    $rs=mysql_query("Select * from stud_test order by test_name",$cn);
