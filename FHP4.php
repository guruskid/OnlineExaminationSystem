...
<?php 						//	START THE PHP SESSION FIRST OF ALL 
	session_start();
...
<html>
	...
	<body>
														...
														<a class="text_icon_expand_item" href="#">
															<span class="text_icon_expand_item_inner">
																...
																<span class="tie_icon_wrapper">
																	<span class="tie_icon glyphicon glyphicon-home"></span>
																</span>
																
																
																<span class="tie_title" onclick="SetPage('ind.html')" >Home</span>
															</span>
														</a>
													</div>
												</div>
													...
													<div class="text_icon_expand_item_wrapper">
														<a class="text_icon_expand_item" href="#">
															<span class="text_icon_expand_item_inner">
																...
																<span class="tie_icon_wrapper">
																	<span class="tie_icon glyphicon glyphicon-pushpin "></span>
																</span>
																
																
																<span class="tie_title" onclick="SetPage('RulesOfExam.html')">Rules Of Exam</span>
															</span>
														</a>
													</div>
												</div>
													...
													<div class="text_icon_expand_item_wrapper">
														<a class="text_icon_expand_item" href="#">
															<span class="text_icon_expand_item_inner">
																...
																<span class="tie_icon_wrapper">
																	<span class="tie_icon glyphicon glyphicon-bookmark"></span>
																</span>
																
																
																<span class="tie_title" onclick="SetPage('MarkingScheme.html')">Marking Scheme</span>
															</span>
														</a>
													</div>
												</div>
													...
													<div class="text_icon_expand_item_wrapper">
														<a class="text_icon_expand_item" href="#">
															<span class="text_icon_expand_item_inner">
																...
																<span class="tie_icon_wrapper">
																	<span class="tie_icon glyphicon glyphicon-user"></span>
																</span>
																
																
																<span class="tie_title" onclick="location='abt.html'">About Us</span>
															</span>
														</a>
													</div>
												</div>
		...
		<!--IFRAME IS USED-->
		<center>
			<iframe id="myframe" height="45%" width="65%">
